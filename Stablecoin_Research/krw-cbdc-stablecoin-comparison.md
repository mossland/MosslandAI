...
* 한국은행은 **디지털 원화(CBDC)** 도입을 연구하고 있으며, 2025년 4~6월 「프로젝트 한강」 1차 실거래 파일럿을 실시(7개 은행, 예금토큰 지갑 약 8만개 개설, 전환액 대비 실사용률 약 42%)했습니다. 2025년 중반 스테이블코인 논의 확대로 2차를 일시 보류했다가, 2026년 3월 참여 은행을 9개로 확대한 2차 파일럿(개인 간 송금·생체인증·실제 정부 지원금 지급 포함)을 개시했으며, 전 은행 참여 대규모 후속 실거래는 2026년 하반기에 계획되어 있습니다.
* 민간의 **원화 스테이블코인**은 디지털자산기본법 제정 추진으로 발행과 유통을 합법화할 계획이나, 2026년 7월 기준 해당 법안은 아직 국회를 통과하지 못한 상태입니다. 은행권은 각사 TF·컨소시엄을 통해 스테이블코인 사업을 준비 중이지만, 2026년 4월 신현송 한국은행 총재 취임 이후 한국은행은 CBDC·예금토큰을 중심에 두고 스테이블코인은 상대적으로 낮은 우선순위로 다루는 방향으로 기조가 이동했습니다.
...
* **스테이블코인**은 국내외 투자 활성화 및 국제 송금에 초점을 맞추고 있으며, 2026년 중반 기준 국내 주요 은행 및 금융기관들이 각사 TF·컨소시엄(예: 은행권 스테이블코인 분과, 금융지주-해외 커스터디 합작사 등)을 통해 스테이블코인 기반 금융 서비스를 준비하고 있습니다. 다만 법적 근거인 디지털자산기본법은 2026년 7월 기준 국회 계류 상태로 제도화가 아직 완료되지 않았습니다.

### 2.4 금융 시스템에 미치는 영향과 주요 쟁점

* CBDC 도입은 금융 위기 시 은행 탈중개화를 유발할 수 있으며, 이를 관리하기 위해 「프로젝트 한강」 설계에는 이용자 유형(개인·법인 등)별 예금토큰 보유한도 차등과 기관용 CBDC 자체의 무이자 구조가 이미 반영되어 있습니다. 다만 2026년 3월 시작된 2차 파일럿에서는 CBDC가 아니라 예금토큰에 대한 이자 계산·지급 및 정부지원금 이자 관리 기능을 은행 시스템과 연계해 새로 시험하고 있습니다.
...
CBDC와 스테이블코인은 디지털 시대에 상호 보완적으로 공존할 가능성이 높습니다. 다만 2026년 중반 기준 한국의 실제 정책 지형은 대등한 병행 추진이라기보다 'CBDC 우위 + 스테이블코인 입법 대기'에 가깝습니다. 2026년 4월 신현송 총재 취임 이후 한국은행은 CBDC·예금토큰을 디지털 통화 생태계의 중심으로 두고 스테이블코인을 보조적 수단으로 규정하는 방향으로 무게중심을 옮겼으며, 원화 스테이블코인 트랙은 2026년 7월 현재 미통과 상태인 디지털자산기본법 입법에 의존하고 있습니다. 따라서 한국은 당분간 CBDC를 우선하면서, 관련 법제가 정비되는 정도에 따라 스테이블코인을 선택적으로 병행 활용하는 방향으로 발전할 것으로 전망됩니다.
...
6. [한국은행 디지털화폐(CBDC) 연구 현황](https://www.bok.or.kr/portal/submain/submain/cbdc.do?menuNo=201136)
